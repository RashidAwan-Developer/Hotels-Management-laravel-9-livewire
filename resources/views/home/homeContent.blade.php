                ...
                @foreach($hotels as $hotel)
                    ...
                    <div style="background: #fff; width: 59rem; border-radius: 2rem; padding:1rem">
                        <div class="hotel_image">
                            @php
                                $sliderImages = (str_replace("public/slider_images", "", json_decode($hotel->sliderImage)));
...
//                                            dd($arraytoString);
                            ...
                            @foreach($sliderImages as $sliderImage)
                                @if($imageCount == 1)
                                    ...
                                    <a href="{{url('hotels/'.$hotel->name)}}">
                                            <img src="{{asset('storage/slider_images/'.$sliderImage )}}" alt="Please Upload An Image" style="border-radius: 1rem; margin-bottom: 10px; width: 570px; height: 300px" >
                                    </a>
                        ...
                        <p><a href="{{url('hotels/'.$hotel->name)}}" class="btn btn-primary btn-luxe-primary">Book Now <i class="ti-angle-right"></i></a></p>
                    </div>
                    @endforeach
            </div>
                ...
                <div class="tab-content-container">
                    <div class="tab-content active show" data-tab-content="tab1">
                        <div class="container">
                            <div class="row">
                                <div class="col-md-6">
                                    <img src="{{asset('assets/home-assets/images/tab_img_1.jpg')}}" class="img-responsive" alt="Image">
                                </div>
                                <div class="col-md-6">
                    ...
                    <div class="tab-content" data-tab-content="tab2">
                        <div class="container">
                            <div class="row">
                                <div class="col-md-6">
                                    <img src="{{asset('assets/home-assets/images/tab_img_2.jpg')}}" class="img-responsive" alt="Image">
                                </div>
                                <div class="col-md-6">
                                    <span class="super-heading-sm">World Class</span>
                    ...
                    <div class="tab-content" data-tab-content="tab3">
                        <div class="container">
                            <div class="row">
                                <div class="col-md-6">
                                    <img src="{{asset('assets/home-assets/images/tab_img_3.jpg')}}" class="img-responsive" alt="Image">
                                </div>
                                <div class="col-md-6">
                                    <span class="super-heading-sm">World Class</span>
                    ...
                    <div class="tab-content" data-tab-content="tab4">
                        <div class="container">
                            <div class="row">
                                <div class="col-md-6">
                                    <img src="{{asset('assets/home-assets/images/tab_img_4.jpg')}}" class="img-responsive" alt="Image">
                                </div>
                                <div class="col-md-6">
                                    <span class="super-heading-sm">World Class</span>
...
{{--                    </div>--}}
                    <div class="tab-content" data-tab-content="tab6">
                        <div class="container">
                            <div class="row">
                                <div class="col-md-6">
                                    <img src="{{asset('assets/home-assets/images/tab_img_6.jpg')}}" class="img-responsive" alt="Image">
                                </div>
                                <div class="col-md-6">
                                    <span class="super-heading-sm">World Class</span>
