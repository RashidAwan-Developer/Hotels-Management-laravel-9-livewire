        ...
        <div class="slider_area" >
            <div class="slider_active owl-carousel" >
                ...
                @foreach($sliderImage as $sliderImage)
                    <img src="{{asset('storage/slider_images/'.$sliderImage )}}" alt="Please Upload An Image" width="400" height="800" >
                @endforeach
...
{{--                            <div class="img_1">--}}
{{--                                <img src="{{asset('storage/aboutUs')}}/{{$hotel->aboutImage1}}" alt="">--}}
{{--                            </div>--}}
{{--                            <div class="img_2">--}}
{{--                                <img src="{{asset('storage/aboutUs')}}/{{$hotel->aboutImage2}}" alt="">--}}
{{--                            </div>--}}
{{--                        </div>--}}
{{--                    </div>--}}
                ...
                <div style="display: flex; flex-direction: row; overflow: auto; white-space: nowrap">
                    @foreach($rooms as $room)
                        @if($room->hotel_id == $hotel->id)
                            <div class="col-xl-4 col-md-4" style="background: #f3f3f3; margin-right: 10px; margin-bottom: 12px">
                                <div class="single_offers">
                                    <div class="about_thumb">
                                        <a href="#">
                                            <img src="{{asset('storage/room_image/'.$room->roomImage )}}" alt="Room Image" style="margin-top: 5px;border-radius: 1rem; width: 450px; height: 300px" >
                                        </a>
                                    </div>
                                    <h3>Room Number: <span style="font-weight: bold">{{$room->roomnumber}}</span></h3>
                                    <ul>
                                        <li>Rent per day: <span style="margin-left:10px; font-weight: bold">{{$room->price}} <span  style="font-size: 0.8rem">PKR</span></span></li>
                                        <li>Capacity:  <span style="margin-left:50px; font-weight: bold">{{$room->capacity}}</span></li>
                                    </ul>
                                    @if(Auth::user())
                                        <a href="{{url('bookroom',Auth::user()->id)}}/{{$room->id}}/{{$hotel->name}}" class="book_now">book now</a>
                                    @else
